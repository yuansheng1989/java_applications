...
public class Circle implements Shape {
	...
	/** create object of an functional interface using lambda expression */
	private ShapeArea area = () -> Math.PI * radius * radius;
	...
	public String toString(){ 
		return "Circle {r=" + (new Double(getRadius()).toString()) + "} perimeter = " + String.format("%.4f", getPerimeter()) 
		+ " area = " + String.format("%.4f", area.get());
	}
